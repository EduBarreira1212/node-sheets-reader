    ...
    return (
        <div className="flex flex-col h-screen justify-center items-center gap-12 bg-gray-100">
            ...
            <form className="flex flex-col w-80 space-y-4">
                ...
                <input type="submit" value="Search" className="mt-6 bg-blue-600 text-white font-semibold py-2 rounded-lg hover:bg-blue-700 cursor-pointer transition duration-300"/>
            </form>
